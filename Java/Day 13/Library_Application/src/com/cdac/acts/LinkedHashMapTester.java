...
public class LinkedHashMapTester {
	...
	public static void main(String[] args) {
		Map<String, Books> linkedHashMap = new LinkedHashMap<>();
		...
		do {
			...
			case 1: {
				...
				linkedHashMap.put(b.getTitle(), b);
			...
			case 2 : {
				...
				Set<Map.Entry<String,Books>> entries = linkedHashMap.entrySet();
			...
			case 3:{
				...
				sc.nextLine();
				String title = sc.nextLine();
				Books b = linkedHashMap.get(title);
